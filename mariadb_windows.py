...
def get_config(options):
    ...
    cfg.libs = ["ws2_32", "advapi32", "kernel32", "shlwapi", "crypt32", "secur32", "bcrypt", "python3"]
    ...
    cfg.extra_compile_args=['-DDEFAULT_PLUGINS_SUBDIR="%s\\\\lib\\\\plugin"' % options["install_dir"].replace(""'\\', '\\\\'), "/MD"]
    return cfg
