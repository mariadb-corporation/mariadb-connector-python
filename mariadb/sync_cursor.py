        ...
        try:
            ...
            if use_bulk or self._force_binary:
                if use_bulk and self._can_use_bulk_execute(data):
                    ...
                    self._completions = self.connection._client.execute_stmt(sql, [bulk_packet], self._config, True)[0]
                    self._completion_index = 0
                else: 
                    ...
                    completions = self.connection._client.execute_stmt(sql, execute_packets, self._config, True)
