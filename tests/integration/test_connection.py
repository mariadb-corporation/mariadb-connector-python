...
class TestConnection(unittest.TestCase):
    ...
    def test_conpy278(self):
        ...
        if is_native() or mariadb.__impl__ in ('c', 'binary'):
    ...
    def test_ssl_fingerprint_validation(self):
        if is_maxscale():
            self.skipTest("test_ssl_connection_with_ca not supported in MaxScale test environment")
    ...
    def test_ssl_connection_with_ca(self):
