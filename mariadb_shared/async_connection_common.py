...
from typing import TYPE_CHECKING, Any, List, Generic, Literal, overload, ClassVar

if TYPE_CHECKING:
    from types import TracebackType
    from typing_extensions import Unpack
    from .connection_params import ConnectionOptions, ConnectionParams

from .async_cursor_common import AsyncCursorCommon
from .constants import STATUS, TPC_STATE
from .rows import DictRow, RowT_co, TupleRow
from .xid import Xid
from .exceptions import ProgrammingError, Error
from . import exceptions as _exc


class AsyncConnectionCommon(ABC, Generic[RowT_co]):
    ...
    @overload
    @classmethod
    async def connect(cls, *args: Any, dictionary: Literal[True], named_tuple: bool = False, **kwargs: Unpack[ConnectionOptions]) -> 'AsyncConnectionCommon[DictRow]': ...
    @overload
    @classmethod
    async def connect(cls, *args: Any, named_tuple: Literal[True], **kwargs: Unpack[ConnectionOptions]) -> 'AsyncConnectionCommon[Any]': ...
    @overload
    @classmethod
    async def connect(cls, *args: Any, dictionary: Literal[False] = ..., named_tuple: Literal[False] = ..., **kwargs: Unpack[ConnectionOptions]) -> 'AsyncConnectionCommon[TupleRow]': ...
    @overload
    @classmethod
    async def connect(cls, *args: Any, **kwargs: Unpack[ConnectionParams]) -> 'AsyncConnectionCommon[Any]': ...
    @classmethod
    @abstractmethod
    async def connect(cls, *args: Any, **kwargs: Unpack[ConnectionParams]) -> 'AsyncConnectionCommon[Any]':
        """
    ...
    @overload
    def cursor(self, cursor_class: type | None = None, *, dictionary: Literal[True], named_tuple: bool = False, **kwargs: Any) -> AsyncCursorCommon[DictRow]: ...
    @overload
    def cursor(self, cursor_class: type | None = None, *, named_tuple: Literal[True], **kwargs: Any) -> AsyncCursorCommon[Any]: ...
    @overload
    def cursor(self, cursor_class: type | None = None, *, dictionary: Literal[False] = ..., named_tuple: Literal[False] = ..., **kwargs: Any) -> AsyncCursorCommon[RowT_co]: ...
    @overload
    def cursor(self, cursor_class: type | None = None, **kwargs: Any) -> AsyncCursorCommon[Any]: ...
    @abstractmethod
    def cursor(self, cursor_class: type | None = None, **kwargs: Any) -> AsyncCursorCommon[Any]:
        """
    ...
    async def __aenter__(self) -> 'AsyncConnectionCommon[RowT_co]':
    ...
    async def show_warnings(self) -> List[RowT_co] | None:
        """
    ...
    async def tpc_recover(self) -> List[RowT_co]:
        """
